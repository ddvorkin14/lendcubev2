...
const Layout = (props) => {
  const { loading, showBreadcrumbs, breadcrumbs, headerTitle, actions, children, showFooter, footer, container } = props;

  return(
    <Container className="pt-4 pb-4 loans-container" fluid={container === 'fluid'}>
      <Card>
